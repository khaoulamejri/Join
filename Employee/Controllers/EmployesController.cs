...
namespace Employee.Controllers
{
    public class EmployesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NumeroPersonne,Nom,Prenom")] Employe employe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NumeroPersonne,Nom,Prenom")] Employe employe)
        {
            if (id != employe.Id)
            {
                return NotFound();
